...
class MovieController extends AbstractController
{
    ...
    public function new(Request $request, MovieRepository $movieRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // if the query parameter redirect is set, redirect to that URL
            $targetRoute = $request->query->get('redirect') ?? 'app_movie_index';

            return $this->redirectToRoute($targetRoute, [], Response::HTTP_SEE_OTHER);
        }
